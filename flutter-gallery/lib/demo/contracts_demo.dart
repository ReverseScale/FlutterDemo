...
class ContactsDemo extends StatefulWidget {
  static const String routeName = '/contacts'; // Used by the Gallery app.
                ...
                IconButton(
                  ...
                  onPressed: (){
                    _scaffoldKey.currentState.showSnackBar(
                      SnackBar(content: Text('Editing isn\'t supported in this screen.'))
                    );
                  },
                ),
                  ...
                  child: _ContactCategory(
                    ...
                    children: <Widget>[
                      _ContactItem(
                        ...
                        onPressed: (){
                          _scaffoldKey.currentState.showSnackBar(SnackBar(content: Text('Pretend that this opened your SMS application.')));
                        },
                        lines: <String>[
                          '(650) 555-1234',
                          '(650) 555-1235',
...
class _ContactItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ThemeData themeData = Theme.of(context);
    final List<Widget> columnChildren = lines.sublist(0, lines.length - 1)
        .map<Widget>((String s) => Text(s)).toList();
