...
class _DataTableDemoState extends State<DataTableDemo> {
  ...
  void _sort<T>(Comparable<T> getField(Dessert d), int index, bool ascending) {
          ...
          PaginatedDataTable(
            ...
            columns: [
              DataColumn(
                ...
                onSort: (int index, bool ascending) => _sort<String>((Dessert d) => d.name, index, ascending)
              ),
              DataColumn(
