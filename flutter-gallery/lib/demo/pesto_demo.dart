...
const String _smallLogoImage = 'logos/pesto/logo_small.png';
const double _appBarHeight = 128.0;
const double _fabHalfSize = 28.0;
const double _recipePageMaxWidth = 500.0;
...
const List<Recipe> pestoRecipes = <Recipe>[
  Recipe(
    name: 'Roasted Chicken',
    author: 'Peter Carlsson',
    ingredientsImagePath: 'food/icons/main.png',
    ingredientsImagePackage: _galleryAssetsPackage,
    ...
    imagePackage: _galleryAssetsPackage,
...
class PestoHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const RecipeGridPage(recipes: pestoRecipes);
  }
}
...
class _RecipeGridPageState extends State<RecipeGridPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: _theme.copyWith(platform: Theme.of(context).platform),
      child: Scaffold(
        key: scaffoldKey,
        floatingActionButton: FloatingActionButton(
          child: Icon(Icons.edit),
          onPressed: () {
            scaffoldKey.currentState.showSnackBar(SnackBar(content: Text('Not supported.')));
          }),
    ...
    return SliverAppBar(
      ...
      flexibleSpace: LayoutBuilder(
        builder: (context, BoxConstraints constraints) {
          ...
          final double t = (appBarHeight - kToolbarHeight) / (_appBarHeight - kToolbarHeight);
          final double extraPadding = Tween(begin: 10.0, end: 24.0).transform(t);
    ...
    return SliverPadding(
      ...
      sliver: SliverGrid(
        gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
          maxCrossAxisExtent: _recipePageMaxWidth,
    ...
    return GestureDetector(
      ...
      child: Card(
        child: Column(
          ...
          children: <Widget>[
            Hero(
              tag: 'packages/$_galleryAssetsPackage/${recipe.imagePath}',
              child: AspectRatio(
                aspectRatio: 4.0 / 3.0,
                child: Image.asset(
                  recipe.imagePath,
...
class _RecipePageState extends State<RecipePage> {
  ...
  final TextStyle menuItemStyle = PestoStyle(fontSize: 15.0, color: Colors.black54, height: 24.0/15.0);
  ...
  Widget build(BuildContext context) {
    ...
    final bool fullWidth = screenSize.width < _recipePageMaxWidth;
      ...
      body: Stack(
        children: <Widget>[
          Positioned(
            ...
            left: 0,
            right: 0,
            height: appBarHeight + _fabHalfSize,
            child: Hero(
              tag: 'packages/$_galleryAssetsPackage/${widget.recipe.imagePath}',
              child: Image.asset(
          ...
          CustomScrollView(
            slivers: <Widget>[
              SliverAppBar(
                expandedHeight: appBarHeight - _fabHalfSize,
              ...
              SliverToBoxAdapter(
                child: Stack(
                  children: <Widget>[
                    Container(
                      padding: EdgeInsets.only(top: _fabHalfSize),
                      width: fullWidth ? null : _recipePageMaxWidth,
...
class RecipeSheet extends StatelessWidget {
  ...
  final TextStyle descriptionStyle = PestoStyle(fontSize: 15.0, color: Colors.black54, height: 24.0/15.0);
  final TextStyle itemStyle = const PestoStyle(fontSize: 15.0, height: 24.0/15.0);
  final TextStyle itemAmountStyle = PestoStyle(fontSize: 15.0, color: _theme.primaryColor, height: 24.0/15.0);
