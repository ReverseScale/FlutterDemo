...
class TypographyDemo extends StatelessWidget {
  static const String routeName = '/typography'; // Used by the Gallery app.

  @override
  Widget build(BuildContext context){
    final TextTheme textTheme = Theme.of(context).textTheme;
    final List<Widget> styleItems = [
    ...
    if (MediaQuery.of(context).size.width > 500.0) {
      styleItems.insert(0, TextStyleItem(name: 'Display 4', style: textTheme.display4, text: 'Light 112sp'));
    }

    return Scaffold(
      appBar: AppBar(title: Text('Typography'),),
      body: SafeArea(child: ListView(children: styleItems,)),
    );
  }
}
