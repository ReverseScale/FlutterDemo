...
class _BackdropState extends State<Backdrop> with SingleTickerProviderStateMixin {
  ...
  static final Animatable<double> _frontOpacityTween = Tween(begin:0.2, end: 1.0)
    .chain(CurveTween(curve: Interval(0.0, 0.4, curve: Curves.easeInOut)));
  ...
  double get _backdropHeight {
    ...
    return math.max(0.0, renderBox.size.height - _backAppBarHeight - _frontClosedHeight);
  }
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    final Animation<RelativeRect> frontRelativeRect = _controller.drive(RelativeRectTween(
      begin: RelativeRect.fromLTRB(0.0, constraints.biggest.height - _frontClosedHeight, 0.0, 0.0),
            ...
            return PhysicalShape(
              ...
              clipper: ShapeBorderClipper(
                shape: BeveledRectangleBorder(
                  borderRadius: _frontHeadingBevelRadius.transform(_controller.value),
                ),
              ),
