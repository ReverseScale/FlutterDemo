...
import 'package:gallery/gallery/backdrop.dart';
import 'package:gallery/gallery/demos.dart';

const String _galleryAssetsPackage = 'flutter_gallery_assets';
const Color _flutterBlue = Color(0xFF003D75);
const double _demoItemHeight = 64.0;
const Duration _frontLayerSwitchDuration = Duration(milliseconds: 300);
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage('logos/flutter_white/logo.png', package: _galleryAssetsPackage))
        ),
      ),
    );
  }
          ...
          children: <Widget>[
            Padding(
              ...
              child: Icon(
                category.icon,
                size: 60.0,
                color: isDark ? Colors.white : _flutterBlue,
              ),
            ),
...
class _CategoriesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<GalleryDemoCategory> list = categories.toList();
    ...
    return Semantics(
      ...
      child: SingleChildScrollView(
        key: PageStorageKey<String>('categories'),
        child: LayoutBuilder(
                ...
                children: List<Widget>.generate(rowCount, (int rowIndex) {
                  ...
                  return Row(
                    children: List<Widget>.generate(columnCountForRow, (int columnIndex) {
                      ...
                      final GalleryDemoCategory category = list[index];
                      return SizedBox(
                        width: columnWidth,
                        height: rowHeight,
                        child: _CategoryItem(
...
class _DemoItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RawMaterialButton(
      ...
      child: Container(
        constraints: BoxConstraints(minHeight: _demoItemHeight * textScaleFactor),
        child: Row(
          children: <Widget>[
            Container(
              width: 56.0,
    ...
    return KeyedSubtree(
      ...
      child: Semantics(
        ...
        child: ListView(
          ...
          children: galleryCategoryToDemos[category].map((GalleryDemo demo) => _DemoItem(demo: demo,)).toList()
        ),
      ),
    );
  }
...
class _GalleryHomeState extends State<GalleryHome> with SingleTickerProviderStateMixin {
  ...
  static Widget _topHomeLayout(Widget currentChild, List<Widget> previousChildren) {
    List children = previousChildren;
  ...
  Widget build(BuildContext context) {
    ...
    Widget home = Scaffold(
      key: _scaffoldKey,
      backgroundColor: isDark ? _flutterBlue : theme.primaryColor,
      body: SafeArea(
        bottom: false,
        child: WillPopScope(
          child: Backdrop(
            ...
            frontAction: AnimatedSwitcher(
              duration: _frontLayerSwitchDuration,
            ...
            frontTitle: AnimatedSwitcher(duration: _frontLayerSwitchDuration,
              child: _category == null
            ...
            frontLayer: AnimatedSwitcher(
              ...
              child: _category != null
                  ...
                  : _CategoriesPage(
                    categories: allGalleryDemoCategories,
