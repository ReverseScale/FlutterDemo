...
class _HomePageState extends State<HomeTPage> with SingleTickerProviderStateMixin{
              ...
              children: <Widget>[
                ...
                new ListTile(   //第一个功能项
                  ...
                  onTap: () {
                    ...
                    Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => GridViewList()));
                  }
                ),
                new ListTile(   //第二个功能项
