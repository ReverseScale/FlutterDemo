    ...
    return Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Image.network(
                'https://raw.githubusercontent.com/flutter/website/master/src/_assets/image/tools/android-studio/hot-reload.gif'),
            Text(
    ...
    var card = Card(
      child: Column(
        children: <Widget>[
          ListTile(
            title: Text(
                'Feature request: map taps listener and makrer drag location update'),
            subtitle: Text('#25439 opened 7 hours ago by AmitToren '),
            leading: Image.network(
                'http://ghexoblogimages.oss-cn-beijing.aliyuncs.com/18-12-17/50339680.jpg'),
          ),
          Divider(),
          ListTile(
          ...
          ListTile(
            title: Text(
                '[Wiki] Obfuscating-Dart-Code page on wiki "xcode_backend.sh" path error'),
      ...
      child: Column(
        children: <Widget>[
          ListTile(
            ...
            leading: Image.network(
                'http://ghexoblogimages.oss-cn-beijing.aliyuncs.com/18-12-17/35746533.jpg'),
          ),
          Divider(),
          ListTile(
